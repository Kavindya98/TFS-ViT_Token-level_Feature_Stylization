...
output_dir=./Results/${datasets}/Fullset/SGD_ReNet/RandConv_One_Step/Lr_e-3_Lam_10_Val_Aug_Full_Model_Clipped
...
# nohup bash bash_scripts/ERM-ViT/ImageNet/ResNet/RandConv_One_Step/Lr_e-3_Lam_10_SGD_RandConv.sh > OUT/SGD_RandConv_One_Step/Lr_e-3_Lam_10_Val_Aug_Full_Model_Clipped.out 2>&1 &