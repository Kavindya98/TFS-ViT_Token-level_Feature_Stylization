...
output_dir=./Results/${datasets}/Fullset/SGD_ReNet/RandConv/Val_Aug_Fixed_Feature_Clipped_No_Invariant
...
# nohup bash bash_scripts/ERM-ViT/ImageNet/ResNet/SGD_RandConv_Val_Augment.sh > OUT/SGD/Val_Aug_Fixed_Feature_Clipped_No_Invariant.out 2>&1 &