...
do
    ...
    --hparams """{\"batch_size\":512,\"lr\":0.0001,\"custom_train_val\":true,\"custom_train\":0,\"custom_val\":1,\"resnet_dropout\":0.0,\"weight_decay\":0.0,\"empty_fc\":true,\"fixed_featurizer\":false}"""
done
