...
output_dir=./Results/${datasets}/ME_ADA_CNN_Corrected_version_corrected_transform
...
# nohup bash bash_scripts/ERM-ViT/CIFAR10/WideResNet/ME_ADA.sh > OUT/CIFAR10/ME_ADA_CNN_Corrected_version_corrected_transform.out 2>&1 &