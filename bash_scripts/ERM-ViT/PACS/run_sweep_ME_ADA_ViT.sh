...
algorithms=ME_ADA_ViT
datasets=PACS_Custom # PACS, VLCS, OfficeHome, TerraIncognita, DomainNet, ImageNet_9 
data_dir=/media/SSD2/Dataset 
output_dir=./Results/${datasets}/ME_ADA_ViT/T2T14_64_PACS_unsplit_2
...
# nohup bash bash_scripts/ERM-ViT/PACS/run_sweep_ME_ADA_ViT.sh > OUT/PACS/ME_ADA/T2T14_64_PACS_unsplit_2.out 2>&1 &