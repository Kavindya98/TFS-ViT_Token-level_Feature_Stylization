...
output_dir=./Results/${datasets}/ADA_CNN/ResNet50_64_PACS_unsplit_corrected
...
# nohup bash bash_scripts/ERM-ViT/PACS/run_sweep_ADA.sh > OUT/PACS/ADA/ResNet50_64_PACS_unsplit_corrected.out 2>&1 &