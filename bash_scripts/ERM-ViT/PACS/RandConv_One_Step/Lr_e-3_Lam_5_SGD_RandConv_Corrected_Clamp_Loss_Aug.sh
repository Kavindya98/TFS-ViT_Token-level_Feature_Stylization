...
output_dir=./Results/${datasets}/RandConv_One_Step/Lr_e-3_Lam_5_SGD_RandConv_Corrected_Clamp_Loss_Org
...
# nohup bash bash_scripts/ERM-ViT/PACS/RandConv_One_Step/Lr_e-3_Lam_5_SGD_RandConv_Corrected_Clamp_Loss_Aug.sh > OUT/PACS/RandConv_Summary/Lr_e-3_Lam_5_SGD_RandConv_Corrected_Clamp_Loss_Org.out 2>&1 &