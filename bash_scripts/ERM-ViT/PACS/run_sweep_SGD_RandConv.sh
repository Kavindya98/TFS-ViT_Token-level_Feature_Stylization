...
output_dir=./Results/${datasets}/RandConv_CNN/ResNet_18
...
do
    ...
    --hparams """{\"batch_size\":32,\"lr\":0.0001,\"resnet_dropout\":0.0,\"weight_decay\":0.0,\"resnet18\":true,\"fixed_featurizer\":false}"""
done
