...
output_dir=./Results/${datasets}/ERM/ResNet_18_2
...
do
    ...
    --hparams """{\"batch_size\":32,\"lr\":0.0001,\"resnet_dropout\":0.0,\"weight_decay\":0.0,\"resnet18\":true,\"empty_fc\":true,\"fixed_featurizer\":false}"""
done
