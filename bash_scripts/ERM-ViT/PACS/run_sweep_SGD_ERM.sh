...
output_dir=./Results/${datasets}/ERM/ResNet18_64_PACS_unsplit_W_BN
...
# nohup bash bash_scripts/ERM-ViT/PACS/run_sweep_SGD_ERM.sh > OUT/PACS/ERM/ResNet18_64_PACS_unsplit_W_BN.out 2>&1 &