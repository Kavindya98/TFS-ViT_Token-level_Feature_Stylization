...
# nohup bash bash_scripts/Evaluvation/RandConv/ResNet_RandConv_Summary/correct_preprocessing/clamp_0.5/one_step/RandConv_One_Step_Lam_5_Val_Aug_Full_Model_Clipped.sh > OUT/ResNet_RandConv_Summary/correct_preprocessing/clamp_0.5/one_step/RandConv_One_Step_Lam_5_Val_Aug_Full_Model_Clipped.out 2>&1 &