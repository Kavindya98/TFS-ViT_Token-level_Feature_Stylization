...
# nohup bash bash_scripts/Evaluvation/RandConv/ResNet_RandConv_Summary/correct_preprocessing/clamp_0.42/one_step/RandConv_One_Step_ImageNet_Val_Lr_e-3_Lam_5_Val_Aug_Full_Model_Corrected_Clamp_20_One_shot.sh > OUT/ResNet_RandConv_Summary/correct_preprocessing/clamp_0.42/one_step/RandConv_One_Step_ImageNet_Val_Lr_e-3_Lam_5_Val_Aug_Full_Model_Corrected_Clamp_20_One_shot.out 2>&1 &