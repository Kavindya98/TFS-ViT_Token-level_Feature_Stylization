...
do
    ...
    --output_dir /home/kavindya/data/Model/TFS-ViT_Token-level_Feature_Stylization/Results/ImageNet-C/SGD_ReNet/ERM --algorithm ${algo} \
...
# nohup bash bash_scripts/Evaluvation/ERM/ImageNet/erm.sh > OUT/ImageNet_C/SGD_ReNet/ERM/ERM.out 2>&1 &