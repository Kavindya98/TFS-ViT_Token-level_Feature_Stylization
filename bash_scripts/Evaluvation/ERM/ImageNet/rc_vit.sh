...
do
    ...
    --saved_model /media/SSD2/kavindya/Model/TFS-ViT_Token-level_Feature_Stylization/Results/ImageNet/Fullset/Small_Epoch_Clipped/RandConv_ViT/ViTBase/t1_s2/IID_best.pkl \
    --device cuda:0
...
# nohup bash bash_scripts/Evaluvation/ERM/ImageNet/rc_vit.sh > rc_vit_c.out 2>&1 &